...
import { StyledBadge } from "../../components/Badge/RippleBadge";
...
const StudentTable = () => {
  ...
  const updateStudentData = async (id) => {
    const url = `https://62dffcf0fa8ed271c47c281b.mockapi.io/students/${id}`;
    let newData = {};
    ...
    try {
      ...
      getStudents();
      setTableData({ name: "", class: "", teacher: "", attendence: 0 });
  ...
  const getStudents = async () => {
    const url = "https://62dffcf0fa8ed271c47c281b.mockapi.io/students";
                ...
                <TableRow key={student.id}>
                  ...
                  <TableCell>
                    {isTableEdit && student.id === id ? (
                      <Input
                        type="text"
                        placeholder={"" + student.attendence}
                        name="attendence"
                        value={tableData.attendence}
                        onChange={studentsUpdateHandler}
                      />
                    ) : (
                      <Box
